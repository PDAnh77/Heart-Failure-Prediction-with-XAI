...
def dataset_feature_selection(
    ...
    balancing_method: Literal["none", "smote", "adasyn"] = Query("none", description="Chọn phương pháp cân bằng dữ liệu: 'none' (không áp dụng), 'smote' (SMOTE oversampling) hoặc 'adasyn' (ADASYN oversampling)"),
):
