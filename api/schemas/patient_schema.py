...
class PatientBase(BaseModel):
    ...
    resting_ecg: str = Field(
        ...,
        pattern="^(Normal|ST|LVH)$",
        description="Resting electrocardiogram results [Normal: Normal, ST: having ST-T wave abnormality (T wave inversions and/or ST elevation or depression of > 0.05 mV), LVH: showing probable or definite left ventricular hypertrophy by Estes' criteria]",
    )
    ...
    st_slope: str = Field(
        ...
        description="The slope of the peak exercise ST segment [Up: upsloping, Flat: flat, Down: downsloping]",
    )
