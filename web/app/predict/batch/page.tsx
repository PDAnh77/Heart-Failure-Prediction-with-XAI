    ...
    return (
        <div className="p-4 flex flex-col">
            <div className="flex justify-between items-start md:items-center mb-8 flex-col md:flex-row gap-4">
                ...
                <Link
                    href="/predict"
                    className="rounded-lg px-5 py-2.5 bg-gray-100 text-gray-700 hover:bg-gray-200 font-semibold transition-colors dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 whitespace-nowrap"
                >
                    Single Prediction
                </Link>
            </div>

            <div className="flex flex-col justify-start align-middle items-center flex-1 my-4">
                <div className="w-full max-w-3xl">
                    ...
                    <button
                        ...
                        className="w-full py-3 my-6 flex justify-center items-center gap-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 dark:disabled:bg-indigo-800 hover:cursor-pointer text-white font-bold rounded-lg transition-colors shadow-lg disabled:cursor-not-allowed"
                    >
                        {submitting ? (
                            <>
