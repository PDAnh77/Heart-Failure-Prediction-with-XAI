...
OUTPUT_PATH = "../input/testing_dataset/test_smote_output.csv"
...
# ----------------------------------------------------------
# 2. KIỂM TRA CÂN BẰNG — chỉ chạy SMOTE khi thực sự mất cân bằng
# ----------------------------------------------------------
if minority_ratio >= 0.9:
    print("\n[SKIP] Dataset đã cân bằng (ratio >= 0.9). SMOTE không cần thiết.")
else:
    # ----------------------------------------------------------
    # 3. ÁP DỤNG SMOTE
    # ----------------------------------------------------------
    ...
    # SMOTE nội suy nên các cột phân loại có thể bị ra số thập phân (VD: 0.6, 1.3)
    # ----------------------------------------------------------
